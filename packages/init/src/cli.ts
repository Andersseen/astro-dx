...
async function init(): Promise<void> {
  console.log('');
  console.log(kleur.bold().cyan('  astro-dx') + kleur.gray(' - Angular-inspired DX for Astro'));
  console.log(kleur.gray('  Community library, not affiliated with the Astro core team.'));
  console.log('');
  ...
  try {
    ...
    if (selected.includes('attributes')) {
      console.log(kleur.white("  import { register, bootstrap } from '@astro-dx/attributes'"));
    }
