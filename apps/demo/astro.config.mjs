  ...
  vite: {
    ...
    resolve: {
      alias: {
        ...
        'astro-dx/events': resolve(__dirname, '../../packages/all/src/events.ts'),
        'astro-dx/attributes': resolve(__dirname, '../../packages/all/src/attributes.ts'),
        'astro-dx/elements': resolve(__dirname, '../../packages/all/src/elements.ts'),
